...
-- Module: autorun/project_overflow/ui/rpg.lua
...
function rpg_ui.draw(ctx)
    ...
    if imgui.tree_node("Derived Stats") then
        ...
        value("Vitality HP Per Point", 20)
    ...
    if imgui.tree_node("RPG Save Slot Synchronization") then
        ...
        value("Player Absent Frames",
            game_save_sync.player_absent_frames)
        value("Title Gap Threshold",
            game_save_sync.title_gap_threshold_frames)
        value("Title Gap Armed",
            game_save_sync.title_gap_armed)
        value("Title Gap Load Serial",
            game_save_sync.title_gap_load_serial)
        value("Last Runtime Player Pointer",
            game_save_sync.last_runtime_player_ptr)
